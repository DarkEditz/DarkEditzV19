/* BY RIMURUBOTZ X DARK EDITZ

=> NOTES
• MAU AMBIL CASE? ADD NAMA RIMURUBOTZ X DARKEDITZ DI THX TO
• JGN DIPERJUAL BELIKAN
• THX TO JGN DI GANTI
• NAMA OTHER RIMURUBOTZ X DARKEDITZ JGN DIHAPUS
*/
const {
    WAConnection,
    MessageType,
...
audio21 = fs.readFileSync('./Audio/dj1.mp3') 
audio22 = fs.readFileSync('./Audio/dj2.mp3') 
audio23 = fs.readFileSync('./Audio/dj3.mp3') 
audio24 = fs.readFileSync('./Audio/dj4.mp3') 
audio25 = fs.readFileSync('./Audio/dj5.mp3') 
audio26 = fs.readFileSync('./Audio/dj6.mp3') 
audio27 = fs.readFileSync('./Audio/dj7.mp3') 
audio28 = fs.readFileSync('./Audio/dj8.mp3') 
audio29 = fs.readFileSync('./Audio/dj9.mp3') 
audio30 = fs.readFileSync('./Audio/dj10.mp3') 
audio31 = fs.readFileSync('./Audio/dj11.mp3') 
audio32 = fs.readFileSync('./Audio/dj12.mp3') 
audio33 = fs.readFileSync('./Audio/dj13.mp3') 
audio34 = fs.readFileSync('./Audio/dj14.mp3') 
audio35 = fs.readFileSync('./Audio/dj15.mp3') 
audio36 = fs.readFileSync('./Audio/dj16.mp3') 
audio37 = fs.readFileSync('./Audio/dj17.mp3') 
audio38 = fs.readFileSync('./Audio/dj18.mp3') 
audio39 = fs.readFileSync('./Audio/dj19.mp3') 
audio40 = fs.readFileSync('./Audio/dj20.mp3') 
audio41 = fs.readFileSync('./Audio/dj21.mp3') 
audio42 = fs.readFileSync('./Audio/dj22.mp3') 
audio43 = fs.readFileSync('./Audio/dj23.mp3') 
audio44 = fs.readFileSync('./Audio/dj24.mp3') 
audio45 = fs.readFileSync('./Audio/dj25.mp3') 
audio46 = fs.readFileSync('./Audio/dj26.mp3') 
audio47 = fs.readFileSync('./Audio/dj27.mp3') 
audio48 = fs.readFileSync('./Audio/dj28.mp3') 
audio49 = fs.readFileSync('./Audio/dj29.mp3') 
audio50 = fs.readFileSync('./Audio/dj30.mp3') 
audio51 = fs.readFileSync('./Audio/dj31.mp3') 
audio52 = fs.readFileSync('./Audio/dj32.mp3') 
audio53 = fs.readFileSync('./Audio/dj33.mp3') 
audio54 = fs.readFileSync('./Audio/dj34.mp3') 
audio55 = fs.readFileSync('./Audio/dj35.mp3') 
            ...
            const nnnyz6 = {contentText: `[ *SELAMAT DATANG* ]\n${tz} *NAME* : @${memJid.split('@')[0]}\n${tz} *GROUP* : ${mdata.subject}\n${tz} *MEMBER* : ${jumlahMem.length}`, footerText: `© DarkEditz by ${nama} || 2022`, buttons: nnnyz5, headerType: 6, locationMessage: nnnyz4.message.locationMessage}
            nayla.sendMessage(mdata.id,  nnnyz6, MessageType.buttonsMessage,{caption: 'whatsapp',"contextInfo": {text: 'DarkEditz', "forwardingScore": 1000000000, isForwarded: true, sendEphemeral: true, "mentionedJid" : [memJid], },sendEphemeral: true})                         
			}
		...
		//	if (nay.key.fromMe) return
           ...
           case 'audio27':
			...
			case 'asupangeayubi':
             ...
             videoMsg = (await nayla.prepareMessageMedia(geayubi, "videoMessage", { thumbnail: geayubi, })).videoMessage
              buttonsMessage = {footerText:'KLIK NEXT UNTUK SELANJUTNYA', videoMessage: videoMsg,
              contentText:`DONE`,buttons,headerType:5}
              prep = await nayla.prepareMessageFromContent(from,{buttonsMessage},{quoted: fhidetag})
              nayla.relayWAMessage(prep)
              break
             case 'asupanaura':
             const naura = await getBuffer(`https://api-alphabot.herokuapp.com/api/asupan/aura?apikey=Alphabot`)
             buttons = [{buttonId: `${prefix}caca`,buttonText:{displayText: `➡️ NEXT`},type:1}]
             videoMsg = (await nayla.prepareMessageMedia(naura, "videoMessage", { thumbnail: naura, })).videoMessage
              buttonsMessage = {footerText:'KLIK NEXT UNTUK SELANJUTNYA', videoMessage: videoMsg,
              contentText:`DONE`,buttons,headerType:5}
              prep = await nayla.prepareMessageFromContent(from,{buttonsMessage},{quoted: fhidetag})
              nayla.relayWAMessage(prep)
            ...
            const bunga = await getBuffer(`https://api-alphabot.herokuapp.com/api/asupan/bunga?apikey=Alphabot`)
             buttons = [{buttonId: `${prefix}caca`,buttonText:{displayText: `➡️ NEXT`},type:1}]
              videoMsg = (await nayla.prepareMessageMedia(bunga, "videoMessage", { thumbnail: bunga, })).videoMessage
              buttonsMessage = {footerText:'KLIK NEXT UNTUK SELANJUTNYA', videoMessage: videoMsg,
              contentText:`DONE`,buttons,headerType:5}
              prep = await nayla.prepareMessageFromContent(from,{buttonsMessage},{quoted: fhidetag})
              nayla.relayWAMessage(prep)
            ...
            const ayu = await getBuffer(`https://api-alphabot.herokuapp.com/api/asupan/ayu?apikey=Alphabot`)
             buttons = [{buttonId: `${prefix}caca`,buttonText:{displayText: `➡️ NEXT`},type:1}]
             videoMsg = (await nayla.prepareMessageMedia(ayu, "videoMessage", { thumbnail: ayu, })).videoMessage
              buttonsMessage = {footerText:'KLIK NEXT UNTUK SELANJUTNYA', videoMessage: videoMsg,
              contentText:`DONE`,buttons,headerType:5}
              prep = await nayla.prepareMessageFromContent(from,{buttonsMessage},{quoted: fhidetag})
              nayla.relayWAMessage(prep)
             ...
             buttons = [{buttonId: `${prefix}caca`,buttonText:{displayText: `➡️ NEXT`},type:1}]
              videoMsg = (await nayla.prepareMessageMedia(caca, "videoMessage", { thumbnail: caca, })).videoMessage
              buttonsMessage = {footerText:'KLIK NEXT UNTUK SELANJUTNYA', videoMessage: videoMsg,
              contentText:`DONE`,buttons,headerType:5}
              prep = await nayla.prepareMessageFromContent(from,{buttonsMessage},{quoted: nay1})
              nayla.relayWAMessage(prep)
              break
			case 'noleptag':
			if (isLimit(sender)) return
           ...
           case 'ppcp':
            if (isBanned) return reply(mess.banned)
             ...
             cewe = await getBuffer(anu.result.female)
              ...
              nayla.sendMessage(from, cowo, image, {quoted: nay1, caption: 'Nih Versi Cowo Nya ^_^' })
              nayla.sendMessage(from, cewe, image, {quoted: nay1, caption: 'Nih Versi Cewe Nya ^_^' })
              break
            case 'indonesia':
            if (isBanned) return reply(mess.banned)
            anu = await getBuffer(`https://api-darkz.herokuapp.com/api/cecan/indonesia?apikey=DarkEditz`)
            nayla.sendMessage(from, anu, image, {quoted: nay1, caption: 'Tu Ngab'})
            break
            case 'korea':
            if (isBanned) return reply(mess.banned)
            anu =await getBuffer(`https://api-darkz.herokuapp.com/api/cecan/korea?apikey=DarkEditz`)
            nayla.sendMessage(from, anu, image, {quoted: nay1,caption: 'Tu Ngab'})
            break
            case 'thailand':
            if (isBanned) return reply(mess.banned)
            anu =await getBuffer(`https://api-darkz.herokuapp.com/api/cecan/thailand?apikey=DarkEditz`)
            nayla.sendMessage(from, anu, image, {quoted: nay1,caption: 'Tu Ngab'})
            break
            case 'china':
            if (isBanned) return reply(mess.banned)
            anu =await getBuffer(`https://api-darkz.herokuapp.com/api/cecan/china?apikey=DarkEditz`)
            nayla.sendMessage(from, anu, image, {quoted: nay1,caption: 'Tu Ngab'})
            break
            case 'malaysia':
            if (isBanned) return reply(mess.banned)
            anu =await getBuffer(https://api-darkz.herokuapp.com/api/cecan/malaysia?apikey=DarkEditz`)
            nayla.sendMessage(from, anu, image, {quoted: nay1,caption: 'Tu Ngab'})
            break
            case 'japan':
            if (isBanned) return reply(mess.banned)
            anu =await getBuffer(https://api-darkz.herokuapp.com/api/cecan/japan?apikey=DarkEditz`)
            nayla.sendMessage(from, anu, image, {quoted: nay1,caption: 'Tu Ngab'})
            break
            case 'vietnam':
            if (isBanned) return reply(mess.banned)
            anu =await getBuffer(https://api-darkz.herokuapp.com/api/cecan/vietnam?apikey=DarkEditz`)
            nayla.sendMessage(from, anu, image, {quoted: nay1,caption: 'Tu Ngab'})
            break
			case 'mygrub':
			case 'mygrup':
...
┃╚══════════════════════
┗━━━━━━━━━━━━━━━━━━━━━━━`    
sound = fs.readFileSync('./X3/menu.mp3')
nayla.sendMessage(from, sound, MessageType.audio, {quoted: nay1, mimetype: 'audio/mp4', ptt:true})
// NOTE : JGN HAPUS THX TO!!
// HAPUS? GW GA UP LAGI OKY
menu4 = "DarkEditz VERSI 18 NEWS"  
            try{ 
